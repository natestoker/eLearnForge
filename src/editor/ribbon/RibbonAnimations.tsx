          ...
          {GALLERY_ITEMS.map((item) => {
            ...
            return (
              <div 
                ...
                className={`anim-tile flex flex-col items-center justify-center gap-1 p-1 rounded-md cursor-pointer border min-w-[56px] h-14 ${isActive ? 'bg-primary/10 border-primary/40 text-primary' : 'hover:bg-surface-container-highest border-transparent text-on-surface-variant hover:text-on-surface'}`}
              >
